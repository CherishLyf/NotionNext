...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '86394b37d587413e99578e233c9dd7e8',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '刘一凡', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '👻', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.xiaqiunong.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '刘一凡, Notion, 博客', // 网站关键词 英文逗号隔开
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '豫ICP备2023017533号-1', // 备案号 闽ICP备XXXXXXX
